...
const motivos = [
  ...
  { id: 4, name: "prefiere presencial", unavailable: false },
];

const motivos2 = [
  { id: 1, name: "parametro", unavailable: false },
  { id: 2, name: "país", unavailable: false },
  { id: 3, name: "no puede en las fechas indicadas", unavailable: false },
  { id: 4, name: "espera para más adelante", unavailable: false },
                  ...
                  <form className="my-10" onSubmit={handleSubmit}>
                    ...
                    <div className="mb-5">
                      ...
                      <input
                        ...
                        placeholder="Ej: Expresa estar interesado para más adelante"
                        value={comentarios}
