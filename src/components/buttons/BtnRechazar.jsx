...
const BtnRechazar = ({ ruta, telefono }) => {
  ...
  return (
    <button
      className={`bg-gray-500 text-gray-100 mb-1 w-28 font-bold p-1 rounded-lg flex items-center justify-center hover:bg-red-600 transition-all cursor-pointer `}
    /*   disabled={cond} */
